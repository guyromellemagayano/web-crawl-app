...
/**
 * Custom function to render the `PagesStatsSkeleton` component
 */
...
/**
 * Memoized custom `PagesStatsSkeleton` component
 */
export const MemoizedPagesStatsSkeleton = memo(PagesStatsSkeleton);
