...
/**
 * Custom function to render the `ImagesStatsSkeleton` component
 */
const ImagesStatsSkeleton = () => {
...
/**
 * Memoized custom `ImagesStatsSkeleton` component
 */
export const MemoizedImagesStatsSkeleton = memo(ImagesStatsSkeleton);
