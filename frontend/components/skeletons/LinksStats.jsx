...
/**
 * Custom function to render the `LinksStatsSkeleton` component
 */
...
/**
 * Memoized custom `LinksStatsSkeleton` component
 */
export const MemoizedLinksStatsSkeleton = memo(LinksStatsSkeleton);
