...
const Pagination = props => {
  ...
  return (
    <PaginationDiv className={`bg-white px-4 pb-4 flex items-center justify-between sm:px-6 align-middle shadow-xs sm:rounded-lg`}>
      ...
      <div className={`w-0 flex-1 flex justify-end`}>
        {currentPage !== totalPages && (
          <Link href={queryExists ? props.pathName + `?page=${parseInt(props.page) + 1}` : props.pathName + `?page=${parseInt(props.page) + 2}`}>
