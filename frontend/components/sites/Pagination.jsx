...
const Pagination = props => {
  ...
  console.log(query.page, currentPage, page, pageNumbers)
  ...
  return (
    <PaginationDiv className={`bg-white px-4 pb-4 flex items-center justify-between border-t border-gray-200 sm:px-6 align-middle shadow sm:rounded-lg`}>
      ...
      <div className={`hidden md:flex`}>
        ...
        {/* <Link href="#">
          <a className={`-mt-px border-indigo-500 pt-4 px-4 inline-flex items-center text-sm leading-5 font-medium text-indigo-600 focus:outline-none focus:text-indigo-800 focus:border-indigo-700 transition ease-in-out duration-150`}>
            2
          </a>
        </Link> */}
      </div>
