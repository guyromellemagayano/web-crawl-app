...
const IssuesStats = () => {
	...
	const SectionTabs = [
		...
		{
			title: isComponentReady && stats ? totalPageIssuesText : <Skeleton duration={2} width={72} height={20} />,
			count: isComponentReady && stats ? pageErrors : <Skeleton duration={2} width={108} height={36} />
		},
		{
			title: isComponentReady && stats ? totalImageIssuesText : <Skeleton duration={2} width={72} height={20} />,
