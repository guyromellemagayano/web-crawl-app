    ...
    <Fragment>
      ...
      {!userLoaded ? (
        ...
        <SidebarDiv ref={ref} className={`flex-shrink-0 flex flex-col relative`}>
          <button 
            type="button" 
            className={`p-4 flex items-center justify-between flex-shrink-0 w-full group block transition ease-in-out duration-150 ${isComponentVisible ? "bg-gray-900" : "hover:bg-gray-900"}`} id="options-menu" 
            aria-haspopup="true" 
          ...
          >
            ...
            <div>
              <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" className={`selector text-white w-6 h-6`}>
            ...
            >
              <div className={`z-10 mx-3 origin-top absolute right-0 left-0 bottom-0 mt-1 mb-20 rounded-md shadow-lg`}>
                <div className={`rounded-md bg-white shadow-xs`} role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                  ...
                  <div className={`py-1`}>
                    <Link href="/dashboard/settings/profile">
                      <a className={`block px-4 py-2 text-sm leading-5 text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:bg-gray-100 focus:text-gray-900`} role="menuitem">View Profile</a>
                    </Link>
                    <Link href="/dashboard/settings/subscriptions">
                      <a className={`block px-4 py-2 text-sm leading-5 text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:bg-gray-100 focus:text-gray-900`} role="menuitem">Subscription Plans</a>
                    </Link>
                    <Link href="/dashboard/settings/payment-details">
                      <a className={`block px-4 py-2 text-sm leading-5 text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:bg-gray-100 focus:text-gray-900`} role="menuitem">Payment Details</a>
                    </Link>
                    <Link href="/dashboard/settings/billing-history">
                      <a className={`block px-4 py-2 text-sm leading-5 text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:bg-gray-100 focus:text-gray-900`} role="menuitem">Billing History</a>
                    </Link>
                    <Link href="/dashboard/settings/global">
                      <a className={`block px-4 py-2 text-sm leading-5 text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:bg-gray-100 focus:text-gray-900`} role="menuitem">App Settings</a>
                    </Link>
                  </div>
                  <div className={`border-t border-gray-100`}></div>
                  <div className={`py-1`}>
