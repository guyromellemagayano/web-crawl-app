                  ...
                  <div className={`sm:col-span-6`}>
                    ...
                    <div className={`mt-2 flex items-center`}>
                      ...
                      <span className={`ml-5 rounded-md shadow-sm`}>
                        <button
                          type={`button`}
                          className={`py-2 px-3 border border-gray-300 rounded-md text-sm leading-4 font-medium text-gray-700 hover:text-gray-500 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue active:bg-gray-100 active:text-gray-800 transition duration-150 ease-in-out`}
                        >
                          Change
                        </button>
                      </span>
