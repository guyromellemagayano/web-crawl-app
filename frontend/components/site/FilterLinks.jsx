              ...
              <div className={`relative inline-block text-left`}>
                ...
                <div
                  className={`origin-top-right absolute right-0 mt-2 w-32 rounded-md shadow-lg ${
                    dropdown
                      ? "block transition ease-out duration-100 transform opacity-0 scale-95 transform opacity-100 scale-100"
                      : "hidden transition ease-in duration-75 transform opacity-100 scale-100 transform opacity-0 scale-95"
                  }`}
                >
