...
const ResetPassword = () => {
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			if (Math.floor(res.status / 200) === 1) {
				...
				setSuccessMsg(
					`Reset password requested. Please check your email to continue the process.`
				);
			} else {
	...
	return (
		<Layout>
			...
			<ResetPasswordDiv
				className={`min-h-screen bg-gray-300 flex flex-col justify-center py-12 sm:px-6 lg:px-8`}
			>
