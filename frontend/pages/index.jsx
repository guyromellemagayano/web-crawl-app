						...
						<main className={`mt-8 sm:mt-16 md:mt-20 lg:mt-24`}>
							<div className={`mx-auto max-w-screen-xl`}>
								<div className={`lg:grid lg:grid-cols-12 lg:gap-8`}>
									<div
										className={`px-4 sm:px-6 sm:text-center md:max-w-2xl md:mx-auto lg:col-span-7 lg:text-left lg:flex lg:items-center`}
									>
										<div>
											<AppLogo
												...
												<Fragment>
													...
													>
														<form onSubmit={handleSubmit}>
															...
															<div className={`mt-6`}>
																<span
																	className={`block w-full rounded-md shadow-xs-sm`}
																>
																	<button
																		type={`submit`}
