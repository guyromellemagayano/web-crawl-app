...
const LinkUnsupported = () => {
  ...
  return (
    <Layout>
      <Head>
        <title>Unsupported Links</title>
      </Head>

      <LinkUnsupportedDiv className={`h-screen flex overflow-hidden bg-gray-100`}>
        <MobileSidebar />
        <MainSidebar />
        <div className={`flex flex-col w-0 flex-1 overflow-hidden`}>
          ...
          >
            <div className={`max-w-6xl mx-auto px-4 md:py-4 sm:px-6 md:px-8`}>
              <h1 className={`text-2xl font-semibold text-gray-900`}>Unsupported Links</h1>
            </div>
...
export default LinkUnsupported

LinkUnsupported.propTypes = {}