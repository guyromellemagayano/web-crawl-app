...
const WorkingDiv = styled.section``
...
const Working = () => {
  ...
  return (
    <Layout>
      ...
      <WorkingDiv className={`h-screen flex overflow-hidden bg-gray-100`}>
        <MobileSidebar />
        ...
        <div className={`flex flex-col w-0 flex-1 overflow-hidden`}>
          ...
          >
            <div className={`max-w-6xl mx-auto px-4 md:py-4 sm:px-6 md:px-8`}>
              <h1 className={`text-2xl font-semibold text-gray-900`}>Working Links</h1>
            </div>
