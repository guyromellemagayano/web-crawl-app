                ...
                <div class="bg-gray-800 pb-32">
                    ...
                    <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                        ...
                        <div className="flex items-center justify-between h-16 px-4 sm:px-0">
                            ...
                            <div className="hidden md:block">
                                ...
                                <a href="/sites" className="ml-4 px-3 py-2 rounded-md text-sm font-medium text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700">Sites</a>
                    ...
                    */}
                    <div className="hidden border-b border-gray-700 md:hidden">
                        ...
                        <a href="/sites" className="mt-1 block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700">Sites</a>
