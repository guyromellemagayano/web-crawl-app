...
const SiteSeoPage = ({ query }) => {
	...
	const siteSeoName = t("sites:sitesSeo", { siteName: siteName });

	return (
		<>
			<NextSeo title={siteSeoName} />
			<MemoizedPageLayout pageTitle={siteSeoName}>
...
export default function SiteSeo({ query, fallback }) {
	return (
		<SWRConfig value={{ fallback }}>
			<SiteSeoPage query={query} />
		</SWRConfig>
	);
}
