...
import { useImageDetail, useSiteId } from "@hooks/useSite";
...
const ImagesDetail = ({ result }) => {
	...
	const imageDetailPageTitle = ImagesLabels[1].label + " - " + siteId?.name + " - " + imageDetail?.url;
												...
												<div tw="px-4 py-5 sm:p-0">
													<dl>
														<div tw="sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5">
															<dt tw="text-sm leading-5 font-medium text-gray-500">{ImagesLabels[6].label}</dt>
														...
														<div tw="mt-8 sm:mt-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5">
															<dt tw="text-sm leading-5 font-medium text-gray-500">{ImagesLabels[7].label}</dt>
															<dd tw="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2">
																{componentReady ? (
																	imageDetail?.type ? (
														...
														<div tw="mt-8 sm:mt-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5">
															<dt tw="text-sm leading-5 font-medium text-gray-500">{ImagesLabels[8].label}</dt>
															<dd tw="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2">
																{componentReady ? (
																	imageDetail?.status ? (
														...
														{imageDetail?.error && (
															<div tw="mt-8 sm:mt-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5">
																<dt tw="text-sm leading-5 font-medium text-gray-500">{ImagesLabels[9].label}</dt>
																<dd tw="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2">
																	{componentReady ? (
														...
														<div tw="mt-8 sm:mt-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5">
															<dt className="text-sm leading-5 font-medium text-gray-500">{ImagesLabels[10].label}</dt>
														...
														<div tw="mt-8 sm:mt-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5">
															<dt tw="text-sm leading-5 font-medium text-gray-500">{ImagesLabels[11].label}</dt>
															<dd tw="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2">
																{imageDetail?.pages !== undefined && imageDetail?.pages.length > 0 ? (
																	<ul>
																		{componentReady ? (
