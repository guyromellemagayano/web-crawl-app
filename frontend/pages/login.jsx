          ...
          <div className={`bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10`}>
            ...
            <div className={`mt-6`}>
              <div className={`relative`}>
                ...
                >
                  <span className={`px-2 bg-white text-gray-1000`}>
                    Or continue with
                  </span>
                </div>
              </div>
                ...
                <div>
                  <span className={`w-full inline-flex rounded-md shadow-sm`}>
                    <a
                      ...
                      type={`button`}
                      className={`w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md bg-white text-sm leading-5 font-medium text-gray-1000 hover:text-gray-400 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue transition duration-150 ease-in-out`}
