              ...
              <div className={`bg-white overflow-hidden shadow rounded-lg`}>
                ...
                <div className={`px-4 pt-16 pb-12 sm:px-8`}>
                      ...
                      <div className={`sm:col-span-3`}>
                        ...
                        <div className={`mt-1 rounded-md shadow-sm`}>
                          <input
                            ...
                            aria-describedby="company-business-name"
                          />
                        </div>
                      </div>
                    </div>
                  ...
                  <div className={`max-w-6xl py-4 m-auto`}>
                    ...
                    <p className={`max-w-full text-sm leading-5 text-gray-500`}>
                      At the end of the day, going forward, a new normal that
                      has evolved from generation X is on the runway heading
                      towards a streamlined cloud solution.
                    </p>
                  ...
                  <div class={`mt-5 mx-auto sm:flex sm:justify-start`}>
                    ...
                    <button
                      type={`button`}
                      class={`mt-3 mr-3 rounded-md shadow sm:mt-0 relative inline-flex items-center px-4 py-2 border border-transparent text-sm leading-5 font-medium rounded-md text-white bg-red-600 hover:bg-red-500 focus:outline-none focus:shadow-outline-red focus:border-red-700 active:bg-red-700`}
                    >
                      Clear Form
                    </button>
                    <button
                    ...
                    <button
                      type={`button`}
                      class={`mt-3 mr-3 rounded-md shadow sm:mt-0 relative inline-flex items-center px-4 py-2 border border-transparent text-sm leading-5 font-medium rounded-md text-white bg-green-600 hover:bg-green-500 focus:outline-none focus:shadow-outline-green focus:border-green-700 active:bg-green-700`}
                    >
                      View Site Dashboard
                    </button>
                  </div>
