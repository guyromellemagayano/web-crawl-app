...
const MobilePrimaryMenu = loadable(() =>
	import('src/components/sidebar/MobilePrimaryMenu')
);
const MobileSettingsMenu = loadable(() =>
	import('src/components/sidebar/MobileSettingsMenu')
);
const MobileSiteMenu = loadable(() =>
	import('src/components/sidebar/MobileSiteMenu')
);
