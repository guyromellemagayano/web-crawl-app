...
// Components
import PaymentMethodForm from 'src/components/form/PaymentMethodForm';
...
const ProfileSettingsSubscription = () => {
	...
	return (
		<>
						...
						>
							...
							<div>
								<div className="text-center sm:mt-3">
									<h2
										className="mb-6 text-lg leading-6 font-medium text-gray-900"
										id="modal-headline"
									>
			...
			<ProfileSettingsSubscriptionDiv className="my-5 max-w-full bg-white shadow-xs rounded-lg">
