...
const SitesSeoStats = ({ width, sid, user }) => {
  ...
  const chartSeries = [
    statsData && statsData.num_pages_without_title !== undefined
      ? statsData.num_pages_without_title
      : 0,
    statsData && statsData.num_pages_without_description !== undefined
      ? statsData.num_pages_without_description
      : 0,
    statsData && statsData.num_pages_without_h1_first !== undefined
      ? statsData.num_pages_without_h1_first
      : 0,
    statsData && statsData.num_pages_without_h2_first !== undefined
      ? statsData.num_pages_without_h2_first
      : 0,
    statsData && statsData.num_pages_seo_ok !== undefined
