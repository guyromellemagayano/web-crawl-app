...
const SitesPagesStats = ({ width, sid, user }) => {
  ...
  const chartSeries = [
    statsData && statsData.num_pages_big !== undefined
      ? statsData.num_pages_big
      : 0,
    statsData && statsData.num_pages_tls_non_ok !== undefined
      ? statsData.num_pages_tls_non_ok
      : 0,
    noPageIssuesData && noPageIssuesData.count !== undefined
