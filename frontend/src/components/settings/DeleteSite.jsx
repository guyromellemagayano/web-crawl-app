    ...
    <Fragment>
      <Transition show={showModal}>
        ...
        >
          ...
          >
            <div
              className={`bg-white rounded-lg px-4 pt-5 pb-4 overflow-hidden transform transition-all sm:max-w-lg sm:w-full sm:p-6`}
              role="dialog"
              aria-modal="true"
      ...
      <DeleteSiteDiv className={`max-w-full bg-white rounded-lg mb-5`}>
