...
// Components
const SuccessNotification = loadable(() =>
  import("src/components/notifications/SuccessNotification")
);
const SettingsTimestampSkeleton = loadable(() =>
  import("src/components/skeletons/SettingsTimestampSkeleton")
);
...
const TimestampSettings = ({ user }) => {
  ...
  const { mutateUser: mutateUser } = useUser({ refreshInterval: 1000 });
