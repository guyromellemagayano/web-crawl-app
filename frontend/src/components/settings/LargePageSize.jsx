...
const SettingsLargePageSizeSkeleton = loadable(() =>
  import("src/components/skeletons/SettingsLargePageSizeSkeleton")
);
      ...
      <div tw="max-w-full lg:max-w-3xl p-8 pt-0 pb-2">
        <Formik
          ...
          validationSchema={Yup.object().shape({
            largepagesizethreshold: Yup.number().required(
              GlobalLabel[12].label
            ),
          })}
