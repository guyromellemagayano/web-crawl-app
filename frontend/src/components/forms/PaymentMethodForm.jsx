...
const CreditCardSvg = loadable(() =>
  import("src/components/svg/solid/CreditCardSvg")
);
const PaymentMethodsSkeleton = loadable(() =>
  import("src/components/skeletons/PaymentMethodsSkeleton")
);
const SelectorSvg = loadable(() =>
  import("src/components/svg/solid/SelectorSvg")
);
                  ...
                  <span tw="relative z-20 w-full inline-flex">
                    ...
                    >
                      {loading
                        ...
                        : PaymentMethodFormLabel[5].label}
                    </button>
                    <button
                      type="button"
                      css={[
                  ...
                  <input
                    ...
                    value={
                      ...
                      Object.keys(currentPaymentMethod).length > 0
                        ? currentPaymentMethod.card.brand
                            .charAt(0)
                            .toUpperCase() +
              ...
              <div tw="flex justify-between flex-col sm:flex-row md:flex-col lg:flex-row">
                <div tw="flex justify-start order-1 sm:flex-row sm:flex-initial sm:w-auto lg:order-1 lg:w-full">
                  <span tw="relative z-10 w-full inline-flex">
                    ...
                    >
                      {loading
                        ? PaymentMethodFormLabel[15].label
                        : PaymentMethodFormLabel[13].label}
                    </button>
                    <button
                      type="button"
                      css={[
