...
// JSON
import VerifyUrlLabel from 'public/labels/pages/sites/verify-url.json';
...
const QuestionMarkCircleSvg = loadable(() =>
	import('src/components/svg/QuestionMarkCircleSvg')
);
							...
							<div tw='flex items-start'>
								...
								<div tw='ml-4 flex-shrink-0 flex'>
									<button
										...
										onClick={() => setSuccessMsgLoaded(!successMsgLoaded)}
									>
										<span tw='sr-only'>{VerifyUrlLabel[25].label}</span>
							...
							>
								...
								<div tw='mt-5 sm:mt-6'>
									<button
										...
										onClick={() =>
											setTimeout(() => setShowHelpModal(!showHelpModal), 150)
										}
									>
											...
											<div tw='mb-5 sm:flex sm:justify-between'>
												<div tw='sm:flex sm:justify-start w-full'>
													<form
														...
														tw='sm:flex sm:items-center w-full'
													>
														<input
															type='hidden'
															value={siteVerifyId}
																		...
																		<span tw='inline-flex'>
																			<Link href='/dashboard/sites' passHref>
																				<a
																					disabled={disableSiteVerify}
																					css={[
																						tw`cursor-pointer w-full mt-3 mr-3 ring-1 ring-black ring-opacity-5 sm:mt-0 relative inline-flex items-center px-4 py-2 border border-transparent text-sm leading-5 font-medium rounded-md text-white bg-yellow-600`,
																						disableSiteVerify
																							? tw`opacity-50 cursor-not-allowed`
