...
import { useSiteId, useStats, useUptime, useUptimeSummary } from "@hooks/useSite";
						...
						<main tw="flex-1 relative max-w-screen-2xl mx-auto overflow-y-auto focus:outline-none" tabIndex="0">
							<div tw="w-full p-6 mx-auto">
								<div tw="max-w-full p-4">
									<Breadcrumbs siteId={parseInt(result?.siteId)} pageTitle={OverviewLabels[0].label} />
									<HeadingOptions
								...
								<div tw="max-w-full p-4 sm:px-6 md:px-4">
									<div tw="grid grid-cols-1 md:grid-cols-4 gap-8">
										...
										<div tw="col-span-1 lg:col-span-2 2xl:col-span-1">
											<LinksStats componentReady={componentReady} sid={parseInt(result?.siteId)} stats={stats} />
										</div>

										<div tw="col-span-1 lg:col-span-2 2xl:col-span-1">
											<PagesStats componentReady={componentReady} sid={parseInt(result?.siteId)} stats={stats} />
										</div>

										<div tw="col-span-1 lg:col-span-2 2xl:col-span-1">
											<ImagesStats componentReady={componentReady} sid={parseInt(result?.siteId)} stats={stats} />
										</div>

										<div tw="col-span-1 lg:col-span-2 2xl:col-span-1">
											<SeoStats componentReady={componentReady} sid={parseInt(result?.siteId)} stats={stats} />
										</div>
