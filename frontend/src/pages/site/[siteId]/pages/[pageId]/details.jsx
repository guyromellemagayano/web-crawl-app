...
const PageDetail = () => {
	...
	const { data: site, error: siteError } = useSWR(() => (query.siteId ? `/api/site/${query.siteId}/` : null), fetcher);
	...
	const { data: page, error: pageError } = useSWR(() => (query.siteId && scanObjId ? pageApiEndpoint : null), fetcher);
	...
	const { data: pageLocation, error: pageLocationError } = useSWR(
		() => (query.siteId && scanObjId && query.pageId ? pageLocationApiEndpoint : null),
		fetcher
	);
		...
		<Layout>
			{pageLocation && page && site && user ? (
				<Fragment>
					...
					<PageDetailDiv className={`h-screen flex overflow-hidden bg-gray-200`}>
						...
						<div className={`flex flex-col w-0 flex-1 overflow-hidden`}>
							<div className={`md:hidden pl-1 pt-1 sm:pl-3 sm:pt-3`}>
								...
								>
									<svg className={`h-6 w-5`} stroke={`currentColor`} fill={`none`} viewBox={`0 0 24 24`}>
										<path
											strokeLinecap={`round`}
									...
									<div>
										...
										<nav className={`hidden sm:flex items-center text-sm leading-5 break-words`}>
											...
											<Link
												...
												as={"/dashboard/site/" + query.siteId + "/pages/" + query.pageId + "/details"}
											>
												<a
									...
									<div className={`bg-white shadow overflow-hidden sm:rounded-lg`}>
										<div className={`px-4 py-5 sm:p-0`}>
											<dl>
												<div className={`sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 sm:py-5`}>
													...
													<dd className={`mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2`}>
														{!user.settings.disableLocalTime ? (
															<Fragment>
																<Moment calendar={calendarStrings} date={pageLocation.created_at} local />
																&nbsp;
																<Moment date={pageLocation.created_at} format="hh:mm:ss A" local />
															</Fragment>
														) : (
															<Fragment>
																<Moment calendar={calendarStrings} date={pageLocation.created_at} utc />
																&nbsp;
																<Moment date={pageLocation.created_at} format="hh:mm:ss A" utc />
															</Fragment>
														)}
													</dd>
												</div>
												...
												>
													<dt className={`text-sm leading-5 font-medium text-gray-500`}>Page Size</dt>
													<dd className={`mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2`}>
												...
												<div
													className={`mt-8 sm:mt-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:border-t sm:border-gray-300 sm:px-6 sm:py-5`}
												>
													<dt className={`text-sm leading-5 font-medium text-gray-500`}>Total Size of Images</dt>
													<dd className={`mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2`}>
												...
												<div
													className={`mt-8 sm:mt-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:border-t sm:border-gray-300 sm:px-6 sm:py-5`}
												>
													<dt className={`text-sm leading-5 font-medium text-gray-500`}>Total Size of Scripts</dt>
													<dd className={`mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2`}>
												...
												<div
													className={`mt-8 sm:mt-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:border-t sm:border-gray-300 sm:px-6 sm:py-5`}
												>
													<dt className={`text-sm leading-5 font-medium text-gray-500`}>Total Size of Stylesheets</dt>
													<dd className={`mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2`}>
										...
										<div className={`px-4 py-5 sm:p-0`}>
											<dl>
												<div
													className={`mt-8 sm:mt-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:border-t sm:border-gray-300 sm:px-6 sm:py-5`}
												>
													<dt className={`text-sm leading-5 font-medium text-gray-500`}>TLS Status - Page</dt>
													<dd className={`mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2`}>
												...
												<div
													className={`mt-8 sm:mt-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:border-t sm:border-gray-300 sm:px-6 sm:py-5`}
												>
													<dt className={`text-sm leading-5 font-medium text-gray-500`}>TLS Status - Resources</dt>
													<dd className={`mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2`}>
