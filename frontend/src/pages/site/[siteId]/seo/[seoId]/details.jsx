		...
		<Layout>
			{pageLocation && page && site && user ? (
				<Fragment>
					...
					<SeoDetailDiv className={`h-screen flex overflow-hidden bg-gray-200`}>
									...
									<div>
										...
										<nav className={`hidden sm:flex items-center text-sm leading-5 break-words`}>
											...
											<Link
												...
												as={"/dashboard/site/" + query.siteId + "/seo/" + query.seoId + "/details"}
											>
												<a
									...
									<div className={`bg-white shadow overflow-hidden sm:rounded-lg`}>
										<div className={`px-4 py-5 sm:p-0`}>
											<dl>
												...
												>
													<dt className={`text-sm leading-5 font-medium text-gray-500`}>Total Number of Links</dt>
													<dd className={`mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2`}>
												...
												<div
													className={`mt-8 sm:mt-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:border-t sm:border-gray-300 sm:px-6 sm:py-5`}
												>
													<dt className={`text-sm leading-5 font-medium text-gray-500`}>First H1 Text</dt>
													<dd className={`mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2`}>
												...
												<div
													className={`mt-8 sm:mt-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:border-t sm:border-gray-300 sm:px-6 sm:py-5`}
												>
													<dt className={`text-sm leading-5 font-medium text-gray-500`}>Second H1 Text</dt>
													<dd className={`mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2`}>
												...
												<div
													className={`mt-8 sm:mt-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:border-t sm:border-gray-300 sm:px-6 sm:py-5`}
												>
													<dt className={`text-sm leading-5 font-medium text-gray-500`}>First H2 Text</dt>
													<dd className={`mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2`}>
												...
												<div
													className={`mt-8 sm:mt-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:border-t sm:border-gray-300 sm:px-6 sm:py-5`}
												>
													<dt className={`text-sm leading-5 font-medium text-gray-500`}>Second H2 Text</dt>
													<dd className={`mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2`}>
