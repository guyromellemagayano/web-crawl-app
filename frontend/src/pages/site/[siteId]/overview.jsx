...
const SitesImagesStats = loadable(() =>
  import("src/components/sites/ImagesStats")
);
const SitesLinksStats = loadable(() =>
  import("src/components/sites/LinksStats")
);
const SitesOverview = loadable(() => import("src/components/sites/Overview"));
const SitesPagesStats = loadable(() =>
  import("src/components/sites/PagesStats")
);
