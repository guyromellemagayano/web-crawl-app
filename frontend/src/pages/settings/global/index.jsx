...
const LargePageSizeSettings = loadable(() =>
  import("src/components/settings/LargePageSize")
);
...
const TimestampSettings = loadable(() =>
  import("src/components/settings/Timestamp")
);
