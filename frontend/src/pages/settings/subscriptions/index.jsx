									...
									<div>
													...
													>
														...
														<div>
															...
															<div className={`text-center sm:mt-3`}>
																...
																<p
																	className={`mb-6 text-base leading-6 font-semibold`}
																>
										...
										>
											<div className={`text-center mb-10`}>
												...
												<p
													className={`mt-3 max-w-4xl mx-auto text-base leading-7 text-gray-600 sm:mt-5 sm:text-xl sm:leading-8`}
												>
											...
											<div className={`flex items-center justify-center`}>
												<p
													className={`text-base leading-7 font-medium text-gray-500 mx-4`}
												>
